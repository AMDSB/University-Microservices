...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.universite.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.universite.security.DomainUserDetailsService", "createSpringSecurityUser");
